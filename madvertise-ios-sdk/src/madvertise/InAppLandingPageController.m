...
- (void)viewDidLoad {
  ...
  //view1.frame = CGRectMake(0.0, 0.0, 320.0, 460.0);
  //view1.alpha = 1.000;
  ...
  //view6.backgroundColor = [UIColor colorWithRed:1.000 green:1.000 blue:1.000 alpha:1.000];
  ...
  overlay = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, 320.0, 460.0 - 44.0)];
  overlay.alpha = 0.800;
  ...
  [spinner setCenter:CGPointMake(320/2.0, 460/2.0 + 25.0)]; 
